...
- **Salario**: 2.500 € mensuales.
- **Derechos**: Salario, seguridad social, vacaciones.
- **Justificación**: 2.200 € es un salario razonable para este puesto, teniendo en cuenta que se requiere habilidad para la ejecución de pruebas y la creación de documentación técnica, pero se necesita un nivel de especialización o responsabilidad tan alta como en los puestos de programación. Este salario está alineado con el mercado para un tester con experiencia intermedia a alta. Un tester puede trabajar remotamente porque su rol se basa en herramientas digitales y tareas que no requieren presencia física constante, como ejecutar pruebas, reportar errores y colaborar en línea con el equipo. Esto permite mayor productividad, flexibilidad y ahorro de tiempo y recursos.
...
- <img src="Contratos/Programador Forntend - Fernanda Pescadi Suares.pdf"> Progrmador Forntend
- <img src="Contratos/Programador Backend - Eugin Kilo Ñam.pdf"> Programador Backend
- <img src="Contratos/Tester y Documentador - Chickell Meowstone Ritus.pdf"> Tester y Documentador
